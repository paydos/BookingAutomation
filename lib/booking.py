...
class BookingAutomation:
    ...
    def make_reservation(self):
        try:
            ...
            button = self.driver.find_element(By.XPATH, '//*[contains(@class,"reservation-button")]')
            button.click()
            time.sleep(4)
        except Exception as e:
    ...
    def change_location(self):
        try:
            ...
            location = self.driver.find_element(By.XPATH, '//*[contains(@class,"location-selector")]')
            location.click()
            time.sleep(2)
        except Exception as e:
    ...
    def type_location(self):
        try:
            ...
            address_box = self.driver.find_element(By.XPATH, '//*[contains(@class,"address-input")]')
    ...
    def choose_floor(self):
        try:
            ...
            floor = self.driver.find_element(By.XPATH, '//*[contains(@class,"floor-selector")]')
            floor.click()
            time.sleep(1)

            floor_box = self.driver.find_element(By.XPATH, '//*[contains(@class,"floor-input")]')
    ...
    def choose_starting_time(self):
        try:
            ...
            start_time_box = self.driver.find_element(By.XPATH, '//*[contains(@class,"start-time-input")]')
    ...
    def choose_finish_time(self):
        try:
            ...
            finish_time_box = self.driver.find_element(By.XPATH, '//*[contains(@class,"finish-time-input")]')
    ...
    def init_search(self):
        try:
            ...
            time.sleep(0.7)
            search = self.driver.find_element(By.XPATH, '//*[contains(@class,"search-button")]')
            search.click()
            time.sleep(0.5)
        except Exception as e:
    ...
    def filters(self):
        ...
        if self.HighResolutionMonitor:
            try:
                ...
                monitor = self.driver.find_element(By.XPATH, '//*[contains(@class,"monitor-filter")]')
        ...
        if self.AdjustableHeightDesk:
            try:
                ...
                time.sleep(1)
                desk = self.driver.find_element(By.XPATH, '//*[contains(@class,"reservable-filter") and contains(text(),"Adjustable Height Desk")]')
        ...
        try:
            ...
            applyFilters = self.driver.find_element(By.XPATH, '//*[contains(@class,"apply-filters-button")]')
            applyFilters.click()
            time.sleep(0.1)
    ...
    def search(self):
        try:
            time.sleep(2)
            search_button = self.driver.find_element(By.XPATH, '//*[contains(@class,"search-button")]')
            search_button.click()
            time.sleep(4)
        except Exception as e:
    ...
    def book_seat(self):
        ...
        try:
            time.sleep(2)
            add = self.driver.find_element(By.XPATH, '//*[contains(@class,"add-to-basket-button")]')
            add.click()
            time.sleep(5)
        ...
        try:
            ...
            time.sleep(3)
            bookButton = self.driver.find_element(By.XPATH, '//*[contains(@class,"booking-screen-button")]')
            bookButton.click()
            time.sleep(3)
        ...
        try:
            ...
            time.sleep(4)
            res_type = self.driver.find_element(By.XPATH, '//*[contains(@class,"reservation-type-selector")]')
            res_type.click()
            time.sleep(1)
        ...
        try:
            ...
            res_type_box = self.driver.find_element(By.XPATH, '//*[contains(@class,"reservation-type-input")]')
        ...
        # Click book
        try:
            book_button = self.driver.find_element(By.XPATH, '//*[contains(@class,"book-button")]')
            book_button.click()
    ...
    def _seat_info(self):
        ...
        try:
            time.sleep(2)
            self.bookingInfo['Desk Location'] = self.seat.find_element(By.XPATH, '//*[contains(@class,"desk-location-info")]').text
        ...
        try:
            time.sleep(2)
            self.bookingInfo['Floor and Address'] = self.seat.find_element(By.XPATH, '//*[contains(@class,"floor-address-info")]').text
